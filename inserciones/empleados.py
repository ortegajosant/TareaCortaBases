...
def insertar_usuario(cantidad):
    """
Funcion: Inserta los datos de los usuarios a la base de datos
:param cantidad: Cantidad de entradas a ingresar en la base de datos
:return: None
  """
...
def insertar_empleado():
    """
Funcion: Inserta las entradas relacionadas con los empleados
:return: None
  """
...
def insertar_pasaporte():
    """
Funcion: Inserta para una cantidad aleatoria de usuarios, los datos de su pasaporte
:return: None
  """
...
def insertar_puesto():
    """
Funcion: Ingresa los distintos puestos que pueden tener los empleados, ya sea en una aerolínea o en un aeropuerto
:return: None
  """
...
def insertar_empleado_aerolinea():
    """
Funcion: Ingresa la cantidad de empleados que trabajan en una aerolínea
:return: None
  """
...
def insertar_empleados_aeropuerto():
    """
Funcion: Ingresa la cantidad de empleados que trabajan en un aeropuerto
:return: None
  """
...
def insertar_equipaje_tiquete():
    """
Funcion: Inserta los tiquetes y los equipajes relacionados a los usuarios que han viajado en todos los vuelos registrados de la base de datos
:return: None
  """
...
def insertar_horarios():
    """
Funcion: Inserta una serie de horarios
:return: None
  """
...
def insertar_horario_trabajo():
    """
Funcion: Inserta los horarios que ha tenido cada empleado y la fecha en la que empezó a laborar en este
:return: None
  """
...
def insertar_telefonos():
    """
Funcion: Inserta los números telefónicos que están relacionados a cada usuario
:return: None
  """
